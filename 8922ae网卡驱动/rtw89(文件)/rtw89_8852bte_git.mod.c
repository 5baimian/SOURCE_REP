...
__used __section("__versions") = {
	...
	{ 0x77141152, "rtw8852bt_chip_info" },
	{ 0x3853ceb0, "rtw89_pci_isr_ax" },
	{ 0xe162925d, "rtw89_pci_disable_intr" },
	{ 0xe2fd41e5, "module_layout" },
};

MODULE_INFO(depends, "rtw89_pci_git,rtw89_8852bt_git");

MODULE_ALIAS("pci:v000010ECd0000B520sv*sd*bc*sc*i*");

MODULE_INFO(srcversion, "2712949305F4F410DFDF91D");
